...
class Itms::SyncPaymentClaimJob < ItmsJob
  def perform(itms_href, downloader: HarvesterUtils::Downloader)
    ...
    ActiveRecord::Base.transaction do
      pc = Itms::PaymentClaim.find_or_initialize_by(itms_id: itms_id)
      ...
      pc.predlozene_deklarovane_vydavky = find_or_create_declared_expenses_by_json(json['predlozeneDeklarovaneVydavky'], pc.predlozene_deklarovane_vydavky, downloader)
