...
RSpec.describe Itms::SyncNrfcApplicationJob, type: :job do
  ...
  context '#perform' do
    ...
    it 'syncs approved nrfc application and all of its attributes' do
      ...
      expect_common_attributes(nrfc_application)
    ...
    context 'when state changes from approved to rejected' do
      it 'resets attributes specific to approved state' do
        ...
        expect(nrfc_application).to have_attributes(
          ...
          pocet_bodov_hodnotenia_celkovy: nil,
          popis_kapacity_ziadatela: nil,
          popis_situacie_po_realizacii: nil,
          popis_sposobu_realizacie: nil,
          popis_vychodiskovej_situacie: nil,
