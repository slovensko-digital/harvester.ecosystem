  ...
  describe '#perform' do
    it 'syncs procurement contract and all of its attributes' do
      ...
      expect(Itms::ProcurementContract.first).to have_attributes(
        ...
        itms_created_at: Time.zone.parse('0001-01-01T00:00:00Z'),
        itms_updated_at: Time.zone.parse('0001-01-01T00:00:00Z'),
        celkova_suma_zmluvy: 0.34177434e6,
